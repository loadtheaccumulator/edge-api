...
func LogConfigAtStartup(cfg *EdgeConfig) {
	...
	allowedConfig := map[string]interface{}{
		...
		"Database.Hostname":         cfg.Database.Hostname,
		...
		"FDO.APIVersion":            cfg.FDO.APIVersion,
		"FDO.URL":                   cfg.FDO.URL,
		"FeatureflagsBearerToken":   cfg.FeatureFlagsBearerToken,
		"FeatureflagsEnvironment":   cfg.FeatureFlagsEnvironment,
		"FeatureflagsURL":           cfg.FeatureFlagsURL,
		"Hostname":                  cfg.Hostname,
		"ImageBuilder.URL":          cfg.ImageBuilderConfig.URL,
		"Inventory.URL":             cfg.InventoryConfig.URL,
		"KafkaBrokers0.Authtype":    cfg.KafkaBrokers[0].Authtype,
		"KafkaBrokers0.Hostname":    cfg.KafkaBrokers[0].Hostname,
		"KafkaBrokers0.Port":        cfg.KafkaBrokers[0].Port,
		"KafkaTopics":               cfg.KafkaTopics,
		"LogLevel":                  cfg.LogLevel,
		"Logging.LogGroup":          cfg.Logging.LogGroup,
		"Logging.Region":            cfg.Logging.Region,
		"MetricsPort":               cfg.MetricsPort,
		"OpenAPI.FilePath":          cfg.OpenAPIFilePath,
		"PlaybookDispatcher.Status": cfg.PlaybookDispatcherConfig.Status,
		"PlaybookDispatcher.URL":    cfg.PlaybookDispatcherConfig.URL,
		"RepoTempPath ":             cfg.RepoTempPath,
		"TemplatesPath":             cfg.TemplatesPath,
		"TenantTranslatorHost":      cfg.TenantTranslatorHost,
		"TenantTranslatorPort":      cfg.TenantTranslatorPort,
		"TenantTranslatorURL":       cfg.TenantTranslatorURL,
